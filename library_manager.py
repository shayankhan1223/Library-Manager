...
# options = st.sidebar.radio("Select an option:", ["Add a book", "Remove a book", "Search for a book", "Display all books", "Display Statistics", "Exit"])

# # Main Page 
# st.title("📚 Personal Library Manager")

# # Logics For "Add a book", "Remove a book", "Search for a book", "Display all books", "Display Statistics", "Exit" radio buttons
...
#               st.error("⚠️ Please fill out all required fields (Title, Author, Publication Year and Genre) before submitting.")
#             else:
...
#     st.session_state.books = []  # Empty list to store book details
...
#                 st.session_state.books = books_filtered  # Update the session state
